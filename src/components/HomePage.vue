...
<div>
    ...
    <el-button class="database" style="z-index: 2;" @click="goSearch">
            </el-button>
    <el-button class="software" style="z-index: 2;">
            </el-button>
    <el-row :gutter="15" style="margin-left: 80%;z-index: 3;">
        <el-col :span="3">
...
<script setup>
    ...
    function home_click(){
      const button = document.querySelector('.icon-home');
      button.style.backgroundColor = 'red';
      button.style.color = 'white';
      console.log('1')
    }
    const goSearch=()=>{
        router.push({name:'databaseView'});
    }
</script>
